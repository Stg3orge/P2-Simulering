\documentclass[10pt,oneside,a4paper,openany]{report}
...
% Set up the graphicx directory folder and where to place your images
\usepackage{caption}
\captionsetup{%
...
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{10pt} % optional
\fancyhead[L]{\nouppercase{\leftmark}}
\fancyhead[R]{\thepage}
