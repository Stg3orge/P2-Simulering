...
namespace A319TS
{
    class GUIMenuTypesVehicles : Form
    {
        ...
        {
            Text = "Vehicle Types";
            Size = new Size(728, 232);
            MinimumSize = new Size(728, 232);
            MaximumSize = new Size(728, 232);
            ShowIcon = false;
            MinimizeBox = false;
            MaximizeBox = false;
            ...
            Acceleration.Size = new Size(80, 22);
            ...
            Deceleration.Size = new Size(80, 22);
            ...
            Add = new Button();
            Add.Text = "Add";
            Add.Location = new Point(136, 124);
            ...
            SetColor.Location = new Point(107, 124);
            ...
            Remove = new Button();
            Remove.Text = "Remove";
            Remove.Location = new Point(620, 153);
            Remove.Size = new Size(75, 23);
            Remove.Click += RemoveClick;
            Controls.Add(Remove);

            Vehicles = new DataGridView();
            Vehicles.Location = new Point(192, 12);
            Vehicles.Size = new Size(503, 135);
