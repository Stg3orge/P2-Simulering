...
GUI MAIN skal som sagt intalisere de andre "core classes" ved opstart af programmet, derudover skal GUI MAIN håntere input fra brugeren. Hvis brugeren f.eks. vægler at tilføje en vej(element), sendes inputet til ToolController.
...
ViewPorten visualisere derfor elementet, altså i dette tilfælde at tegne vejen i projektet.
